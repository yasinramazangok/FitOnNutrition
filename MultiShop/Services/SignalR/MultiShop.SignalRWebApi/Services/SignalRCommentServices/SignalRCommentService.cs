...
namespace MultiShop.SignalRWebApi.Services.SignalRCommentServices
{
    public class SignalRCommentService : ISignalRCommentService
    {
        ...
        public async Task<int> GetTotalCommentCount()
        {
            ...
            var responseMessage = await client.GetAsync("http://localhost:7075/api/UserCommentStatistics");
