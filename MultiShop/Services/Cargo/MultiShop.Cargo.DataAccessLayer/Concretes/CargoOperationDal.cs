...
{
    public class CargoOperationDal : GenericRepositoryDal<CargoOperation>, ICargoOperationDal
    {
        public CargoOperationDal(CargoContext cargoContext) : base(cargoContext)
        {
